...
from task_05.search import process_query

INDEX_FILE = '..//task_01/downloaded_pages/index.txt'
...
def index():
    ...
    if request.method == 'POST':
        ...
        if links_result:
            return render_template('search.html', input_value=input_value, result=links_result[:10])
        else:
            return render_template('search.html', input_value=input_value,
