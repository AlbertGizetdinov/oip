...
# Пути и файлы
LEMMAS_TFIDF = '../task_04/lemmas_tf_idf'
LEMMAS_TFIDF_PATH = '../task_04/lemmas_tf_idf/'
LEMMA_TOKENS_FILE = '../task_02/lemmas.txt'
INVERTED_INDEX_FILE = '../task_03/inverted_index.txt'
...
if __name__ == '__main__':
    while True:
        search_input = input("Введите запрос (введине \".\" для выхода): ")
